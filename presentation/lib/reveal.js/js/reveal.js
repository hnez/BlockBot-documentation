...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		// Slide Timer bar
		dom.stimer = createSingletonNode( dom.wrapper, 'div', 'slidetimer', '<span></span>' );
		dom.stimerbar = dom.stimer.querySelector( 'span' );
	...
	function configure( options ) {
		...
		dom.controls.style.display = config.controls ? 'block' : 'none';
	        dom.progress.style.display = config.progress ? 'block' : 'none';
                dom.stimer.style.display = config.progress ? 'block' : 'none';
	...
	function updateTimer() {
		...
		// Update progress if enabled
		if( config.progress && dom.stimerbar ) {

			dom.stimerbar.style.width = getTimer() * dom.wrapper.offsetWidth + 'px';
